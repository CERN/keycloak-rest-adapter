...
class TestClientSecretApi(WebTestBase):
    ...
    def test_valid_credentials_get_client_secret_found(self):
        ...
        self.keycloak_api_mock.display_client_secret.return_value.json.return_value = mock_response
    ...
    def test_regenerate_client_secret_found(self):
        ...
        self.keycloak_api_mock.regenerate_client_secret.return_value.json.return_value = mock_response

        # act
        resp = self.app_client.post(f"{API_ROOT}/client/openid/{client_id}/client-secret")

        # assert
        self.keycloak_api_mock.regenerate_client_secret.assert_called_with(client_id)
        self.assertEqual(200, resp.status_code, "Response should have been 200")
        self.assertDictEqual(mock_response, resp.json, "Response should have been the dictionary expected")
